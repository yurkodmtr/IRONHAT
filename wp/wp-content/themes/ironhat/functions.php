...
function ironhat_scripts() {
	...
	wp_enqueue_script( 'ironhat-jq',  'https://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js', array(), time() , true );
	wp_enqueue_script( 'ironhat-js', get_template_directory_uri() . '/js/app.js', array(), time() , true );
}
